...
class MySpider(CrawlSpider):
	...
	def parser(self, response):
		...
		description_list = ''.join(divs.xpath('//*[@id="mainContent"]/main/section[3]/div[1]/div[1]/article/p[1]/text()').extract())
		long_description_list = ''.join(divs.xpath('//*[@id="mainContent"]/main/section[3]/div[1]/div[1]/article/p[2]/text() | //*[@id="mainContent"]/main/section[3]/div[1]/div[1]/article/p[4]/span/text() | //*[@id="mainContent"]/main/section[3]/div[1]/div[1]/article/p[4]/text()').extract())
